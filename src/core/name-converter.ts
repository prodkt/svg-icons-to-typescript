 ...
 */
export function convertFigmaFilenameToComponentName(filename: string): string {
 ...
 */
export function convertFigmaFilenameToOutputFilename(filename: string): string {
  // Remove file extension
  const nameWithoutExt = filename.replace(/\.(svg|tsx|jsx)$/i, '');
 ...
 */
export function convertFigmaFilenameToTitle(filename: string): string {
  // Remove file extension
  const nameWithoutExt = filename.replace(/\.(svg|tsx|jsx)$/i, '');
 ...
 */
export function sanitizeForFilePath(str: string): string {
  return str
